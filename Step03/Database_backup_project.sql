...
INSERT INTO `contract` VALUES (512,11000,'2000-01-01','2022-01-01',1023452569,10),(513,1800,'2006-01-01','2009-01-01',1445525690,20),(514,4000,'2004-01-01','2006-01-01',1785592569,30),(515,900,'2004-01-01','2010-01-01',1785592569,10),(516,1000,'2005-01-01','2010-01-01',1884560847,10),(517,623,'2005-03-05','2014-03-05',1884560847,20),(518,1800,'2008-03-06','2020-03-06',1884560847,30),(519,2000,'2011-06-04','2017-06-04',1884560847,40),(520,1200,'2011-06-04','2015-06-04',1542147114,40),(521,2000,'2011-11-09','2014-11-09',1445547451,10),(522,900,'2011-07-05','2015-07-05',1445477457,30),(523,1500,'2012-03-08','2015-03-08',1024782463,10),(524,1800,'2012-08-09','2019-08-09',1024782463,20),(525,900,'2013-09-05','2019-09-05',1841204754,30),(526,900,'2013-09-05','2018-09-05',1784585254,30),(527,900,'2015-11-10','2022-11-10',1745242426,30),(529,400,'2017-04-30','2023-04-30',1124834578,40),(530,1200,'2017-06-02','2020-06-02',1486542484,40),(531,1500,'2017-06-03','2025-06-03',1946923008,10),(532,4800,'2017-06-04','2026-06-04',1256452238,20),(533,4000,'2018-09-05','2026-09-05',1592227645,10),(534,4800,'2018-09-05','2026-09-05',1592227645,20),(535,1800,'2018-09-05','2024-09-05',1592227645,30),(536,1600,'2018-09-05','2026-09-05',1592227645,40),(539,500,'2024-12-15','2025-12-15',178663326,10),(540,1000,'2024-12-15','2025-12-15',1023452569,10);
...
CREATE TABLE `customer` (
  ...
  `con_sum` int DEFAULT NULL,
  PRIMARY KEY (`AFM`),
  CONSTRAINT `phone_check` CHECK (regexp_like(`phone`,_utf8mb4'^[+][0-9]{12}$'))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `customer` VALUES (178663326,'John','Velasco','Athens','C','+302115055293',500),(1023452569,'Stefan','Hunnam','California','A','+602103625956',12000),(1024782463,'Shamkant','Navathe','Michigan','D','+852103659569',3300),(1124834578,'Periklis','Megalos','Volos','A','+302115858645',400),(1256452238,'Alexandra','Denman','Patras','A','+302100585464',4800),(1415541574,'Tatiana','Raptis','Thessaloniki','Z','+302105448542',0),(1445477457,'Ramez','Elmasri','Dublin','C','+662108544615',900),(1445525690,'Henry','Cavill','Chicago','B','+902104135956',1800),(1445547451,'Margarita','Koumpouri','Athens','B','+302115475668',2000),(1486542484,'Liliana','Beckham','Chicago','C','+902138524656',1200),(1542147114,'Paola','Velasco','Athens','A','+302114522704',1200),(1592227645,'Thea','Wade','Athens','B','+302118548646',12200),(1745242426,'Andreas','Dimitrios','Volos','I','+302108564524',900),(1784585254,'Kostas','Pappas','Lamia','B','+302135874572',900),(1785527877,'James','Smith','Thessaloniki','D','+302103765556',0),(1785592569,'Orlando','Bloom','Athens','C','+302103681956',4900),(1841204754,'Maria','Papadopoulou','Patras','A','+302117941554',900),(1884560847,'Jason','Steven','Kavala','E','+302108741262',5423),(1946923008,'HENDerson','Gibb','California','C','+602126799446',1500);
...
CREATE TABLE `insurance_customer` (
  ...
  KEY `AFM` (`AFM`),
  CONSTRAINT `insurance_customer_ibfk_1` FOREIGN KEY (`AFM`) REFERENCES `customer` (`AFM`),
  CONSTRAINT `insurance_customer_ibfk_2` FOREIGN KEY (`insurance_code`) REFERENCES `insurance` (`insurance_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `monthlypayment` (
  ...
  `m_cost` decimal(7,2) DEFAULT NULL,
...
INSERT INTO `monthlypayment` VALUES (1445547451,'2013-12-27',1,41.67),(1592227645,'2023-09-27',4,133.33),(1592227645,'2025-09-27',3,108.33);
...
-- Dump completed on 2020-12-16  2:59:52
